...
<head>
   ...
   <title>Kittivate Shoping Online</title>


   <link href="<?php echo base_url().'assets/css/bootstrap.min.css'; ?>" rel="stylesheet">
   <link href="<?php echo base_url().'assets/css/font-awesome.css' ?>" rel="stylesheet">
   <link href="<?php echo base_url().'assets/jqui/css/smoothness/jquery-ui-1.10.3.custom.css' ?>" rel="stylesheet">
...
<body>
    ...
    try {Histats.start(1,1666044,4,0,0,0,"");
    Histats.track_hits();} catch(err){};
    </script></a>
    <noscript><a href="http://www.histats.com" target="_blank"><img  src="http://sstatic1.histats.com/0.gif?1666044&101" alt="free tracking" border="0"></a></noscript>
    <!-- Histats.com  END  -->